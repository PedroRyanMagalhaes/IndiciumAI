# 📊 Análise Northwind - Dashboard Automatizado

> Análise completa do banco de dados Northwind com geração automatizada de relatórios e visualizações interativas
...
- 🔄 **Importação Automatizada**: Carrega 14 tabelas CSV diretamente para SQLite
- 🔍 **Auditoria de Dados**: Validação automática de integridade com detecção de valores nulos
